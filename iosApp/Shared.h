...
- (void)eTag:(NSString *)tag message:(NSString *)message exception:(SharedKotlinThrowable * _Nullable)exception __attribute__((swift_name("e(tag:message:exception:)")));
...
- (void)logErrorTag:(NSString *)tag message:(NSString *)message exception:(SharedKotlinThrowable *)exception __attribute__((swift_name("logError(tag:message:exception:)")));
@property BOOL enabled __attribute__((swift_name("enabled")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthTokenResponse")))
@interface SharedAuthTokenResponse : SharedBase
- (instancetype)initWithAccessToken:(NSString * _Nullable)accessToken refreshToken:(NSString * _Nullable)refreshToken errorMessage:(NSString * _Nullable)errorMessage __attribute__((swift_name("init(accessToken:refreshToken:errorMessage:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedAuthTokenResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedAuthTokenResponse *)doCopyAccessToken:(NSString * _Nullable)accessToken refreshToken:(NSString * _Nullable)refreshToken errorMessage:(NSString * _Nullable)errorMessage __attribute__((swift_name("doCopy(accessToken:refreshToken:errorMessage:)")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="accessToken")
*/
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="refreshToken")
*/
@property (readonly) NSString * _Nullable refreshToken __attribute__((swift_name("refreshToken")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AuthTokenResponse.Companion")))
@interface SharedAuthTokenResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedAuthTokenResponseCompanion *shared __attribute__((swift_name("shared")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Boost.Companion")))
@interface SharedBoostCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedBoostCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CustomAPIError")))
@interface SharedCustomAPIError : SharedBase
- (instancetype)initWithMessage:(NSString *)message __attribute__((swift_name("init(message:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCustomAPIErrorCompanion *companion __attribute__((swift_name("companion")));
- (SharedCustomAPIError *)doCopyMessage:(NSString *)message __attribute__((swift_name("doCopy(message:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CustomAPIError.Companion")))
@interface SharedCustomAPIErrorCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCustomAPIErrorCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CustomAPIException")))
@interface SharedCustomAPIException : SharedKtor_client_coreResponseException
- (instancetype)initWithApiError:(SharedCustomAPIError *)apiError response:(SharedKtor_client_coreHttpResponse *)response responseText:(NSString *)responseText __attribute__((swift_name("init(apiError:response:responseText:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithResponse:(SharedKtor_client_coreHttpResponse *)response cachedResponseText:(NSString *)cachedResponseText __attribute__((swift_name("init(response:cachedResponseText:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (readonly) SharedCustomAPIError *apiError __attribute__((swift_name("apiError")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LoginPayload")))
@interface SharedLoginPayload : SharedBase
- (instancetype)initWithUsername:(NSString *)username password:(NSString *)password expiresInMins:(int32_t)expiresInMins __attribute__((swift_name("init(username:password:expiresInMins:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedLoginPayloadCompanion *companion __attribute__((swift_name("companion")));
- (SharedLoginPayload *)doCopyUsername:(NSString *)username password:(NSString *)password expiresInMins:(int32_t)expiresInMins __attribute__((swift_name("doCopy(username:password:expiresInMins:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="expiresInMins")
*/
@property (readonly) int32_t expiresInMins __attribute__((swift_name("expiresInMins")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LoginPayload.Companion")))
@interface SharedLoginPayloadCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedLoginPayloadCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (class, readonly, getter=companion) SharedNetworkClientCompanion *companion __attribute__((swift_name("companion")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)loginEmail:(NSString *)email password:(NSString *)password completionHandler:(void (^)(NSArray<SharedBoost *> * _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("login(email:password:completionHandler:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NetworkClient.Companion")))
@interface SharedNetworkClientCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedNetworkClientCompanion *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *LOGGER_TAG __attribute__((swift_name("LOGGER_TAG")));
...
@protocol SharedKtor_client_loggingLogger
@required
- (void)logMessage:(NSString *)message __attribute__((swift_name("log(message:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NetworkClient.CustomHttpLogger")))
@interface SharedNetworkClientCustomHttpLogger : SharedBase <SharedKtor_client_loggingLogger>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)logMessage:(NSString *)message __attribute__((swift_name("log(message:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RefreshTokenPayload")))
@interface SharedRefreshTokenPayload : SharedBase
- (instancetype)initWithRefreshToken:(NSString *)refreshToken expiresInMins:(int32_t)expiresInMins __attribute__((swift_name("init(refreshToken:expiresInMins:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedRefreshTokenPayloadCompanion *companion __attribute__((swift_name("companion")));
- (SharedRefreshTokenPayload *)doCopyRefreshToken:(NSString *)refreshToken expiresInMins:(int32_t)expiresInMins __attribute__((swift_name("doCopy(refreshToken:expiresInMins:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RefreshTokenPayload.Companion")))
@interface SharedRefreshTokenPayloadCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedRefreshTokenPayloadCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("StartupData")))
@interface SharedStartupData : SharedBase
- (instancetype)initWithVersion:(NSString *)version minIOSVersion:(NSString *)minIOSVersion minAndroidVersion:(NSString *)minAndroidVersion apiUrl:(NSString *)apiUrl __attribute__((swift_name("init(version:minIOSVersion:minAndroidVersion:apiUrl:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedStartupDataCompanion *companion __attribute__((swift_name("companion")));
- (SharedStartupData *)doCopyVersion:(NSString *)version minIOSVersion:(NSString *)minIOSVersion minAndroidVersion:(NSString *)minAndroidVersion apiUrl:(NSString *)apiUrl __attribute__((swift_name("doCopy(version:minIOSVersion:minAndroidVersion:apiUrl:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="api_url")
*/
@property (readonly) NSString *apiUrl __attribute__((swift_name("apiUrl")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="min_android_version")
*/
@property (readonly) NSString *minAndroidVersion __attribute__((swift_name("minAndroidVersion")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="min_ios_version")
*/
@property (readonly) NSString *minIOSVersion __attribute__((swift_name("minIOSVersion")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("StartupData.Companion")))
@interface SharedStartupDataCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedStartupDataCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface SharedSuccessResponse : SharedBase
...
@property (class, readonly, getter=companion) SharedSuccessResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedSuccessResponse *)doCopySuccess:(BOOL)success __attribute__((swift_name("doCopy(success:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SuccessResponse.Companion")))
@interface SharedSuccessResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedSuccessResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("LocalStore")))
@interface SharedLocalStore : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
- (SharedDouble * _Nullable)getDoubleKey:(NSString *)key __attribute__((swift_name("getDouble(key:)")));
- (double)getDoubleKey:(NSString *)key defaultValue:(double)defaultValue __attribute__((swift_name("getDouble(key:defaultValue:)")));
- (SharedFloat * _Nullable)getFloatKey:(NSString *)key __attribute__((swift_name("getFloat(key:)")));
...
- (SharedLong * _Nullable)getLongKey:(NSString *)key __attribute__((swift_name("getLong(key:)")));
...
- (void)cancelCause:(SharedKotlinThrowable * _Nullable)cause __attribute__((swift_name("cancel(cause:)")));
