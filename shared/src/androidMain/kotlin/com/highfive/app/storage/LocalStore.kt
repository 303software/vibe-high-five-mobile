...
actual class LocalStore {
    ...
    actual constructor() {
        sharedPreferences = application.getSharedPreferences(NetworkClient.LOGGER_TAG, Context.MODE_PRIVATE)
    }
    ...
    actual fun getDouble(key: String, defaultValue: Double): Double {
        return java.lang.Double.longBitsToDouble(sharedPreferences.getLong(key, java.lang.Double.doubleToLongBits(defaultValue)))
    }
